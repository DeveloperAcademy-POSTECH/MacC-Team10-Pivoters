...
public enum FormationType: String {
    ...
    public func returnPosition() -> [CGSize] {
        ...
        case .form442:
            return [
                CGSize(width: 0, height: 100),
                CGSize(width: -75, height: 50), CGSize(width: 75, height: 50),
                CGSize(width: 140, height: 30), CGSize(width: -140, height: 30),
                CGSize(width: 0, height: 20), CGSize(width: 70, height: -20),
        ...
        case .form121:
            return [
                CGSize(width: 0, height: 100), CGSize(width: -75, height: 50),
                CGSize(width: 75, height: 50), CGSize(width: 140, height: 30)
            ]
        case .form22:
            return [
                CGSize(width: 0, height: 100), CGSize(width: -75, height: 50),
